...
Why: needed to start the LIBERO-Pro track per [[liberopro-pro-hybrid-guide]] (resources/libero/PRO_HYBRID_GUIDE.md). Hybrid LLM+Pi0.5 evaluation on P1/P2 perturbations.
