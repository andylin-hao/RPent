...
`pi05_libero130_fullshot/30000` on libero_spatial tasks 0/1/2 (3 seeds each, 27 rollouts total via `examples/embodiment/primitives/test_pick_generalization.py`):
...
- Driver lives at `/mnt/public2/zhangyixian/RLinf_agentic/examples/embodiment/primitives/`.
